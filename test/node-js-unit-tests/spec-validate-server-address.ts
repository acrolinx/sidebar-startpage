...
describe('validate-server-address', () => {
  describe('https is not required', () => {
    ...
    it('http server default port', () => {
      ...
      assertDeepEqual(sanitizeAndValidateServerAddress('http://integration2.acrolinx.com:8031', opts), expectedSanitizedServerAddress);
      assertDeepEqual(sanitizeAndValidateServerAddress('http://integration2.acrolinx.com', opts), expectedSanitizedServerAddress);
      assertDeepEqual(sanitizeAndValidateServerAddress('integration2.acrolinx.com:8031', opts), expectedSanitizedServerAddress);
      assertDeepEqual(sanitizeAndValidateServerAddress('integration2.acrolinx.com', opts), expectedSanitizedServerAddress);
    });

    it('https server default port', () => {
      const expectedSanitizedServerAddress = ok('https://integration2.acrolinx.com:443');
      assertDeepEqual(sanitizeAndValidateServerAddress('https://integration2.acrolinx.com:443', opts), expectedSanitizedServerAddress);
      assertDeepEqual(sanitizeAndValidateServerAddress('https://integration2.acrolinx.com', opts), ok('https://integration2.acrolinx.com'));
      assertDeepEqual(sanitizeAndValidateServerAddress('integration2.acrolinx.com:443', opts), expectedSanitizedServerAddress);
    });
    ...
    it('https server custom port', () => {
      assertDeepEqual(sanitizeAndValidateServerAddress('https://integration2.acrolinx.com:555', opts), ok('https://integration2.acrolinx.com:555'));
    });
    ...
    it('proxy path on http with port', () => {
      assertDeepEqual(sanitizeAndValidateServerAddress('/proxy', {
        windowLocation: {
          protocol: 'http:',
          hostname: 'windowhost',
          port: '3000'
  ...
  describe('https is required', () => {
    ...
    it('http server default port', () => {
      ...
      assertDeepEqual(sanitizeAndValidateServerAddress('integration2.acrolinx.com:8031', opts), ok('https://integration2.acrolinx.com:8031'));
      assertDeepEqual(sanitizeAndValidateServerAddress('integration2.acrolinx.com', opts), ok('https://integration2.acrolinx.com'));
    });
    ...
    it('http server custom port', () => {
      assertDeepEqual(sanitizeAndValidateServerAddress('http://integration2.acrolinx.com:555', opts), err(getTranslation().serverSelector.message.serverIsNotSecure));
    });
    ...
    it('full proxy path', () => {
      ...
      assertDeepEqual(sanitizeAndValidateServerAddress('http://aem.com/proxy', opts), err(getTranslation().serverSelector.message.serverIsNotSecure));
    });
